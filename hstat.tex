...
Consider an ice domain $\Omega \subset \R^3$ lying between a Lipschitz continuous bed $b \in C^0(\R^2)$ and surface $s
...
This geometric multigrid method demonstrates textbook multigrid efficiency for extreme topography and basal conditions and offers $\bigO(1000)$ speedups relative to Picard linearization and one-level domain decomposition with incomplete factorization, the methods currently used to solve these equations~\cite{seacism,issm,johnson2007modeling,desmedt2010using,pattyn2003ntd}.
