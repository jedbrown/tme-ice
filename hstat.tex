...
Finally, we remark that when using grid sequencing and method in the last row of Table~\ref{tab:xmg}, the problem can be solved in 7 Newton iterations on the fine level and an average of 5.4 V-cycles per Newton.
