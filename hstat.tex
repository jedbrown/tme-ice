...
These are runtime options in the present code; but since they did not offer a clear benefit they have not been pursued in the present work.
...
\begin{figure}
  ...
  \caption{A solution cutout for test $X$ at $L=\SI{10}{\kilo\metre}$ with $m=1/10$ nearly plastic basal yield model.
